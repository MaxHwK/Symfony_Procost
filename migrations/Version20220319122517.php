 ...
 */
final class Version20220319122517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE working_hours (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, employee_id INT NOT NULL, nb_days INT NOT NULL, creation_date DATETIME NOT NULL, INDEX IDX_D72CDC3D166D1F9C (project_id), INDEX IDX_D72CDC3D8C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE employee ADD CONSTRAINT FK_5D9F75A1BE04EA9 FOREIGN KEY (job_id) REFERENCES job (id)');
        $this->addSql('ALTER TABLE working_hours ADD CONSTRAINT FK_D72CDC3D166D1F9C FOREIGN KEY (project_id) REFERENCES project (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE working_hours DROP FOREIGN KEY FK_D72CDC3D166D1F9C');
